...
//
// `verif/demo_sandbox/preproc.py` runs before compile and writes a
...
// `spec/demo_sandbox/sandbox_model.py`. The absolute path is passed in via
// the `VECTORS` plusarg.
//
...
module tb_top;
  ...
  bind demo_sandbox_alu cov_alu u_cov (.*);
