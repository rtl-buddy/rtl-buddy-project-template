...
test's `TEST` plusarg, expands it through `spec/demo_sandbox/sandbox_model.py`
...
# of cwd at runtime.
_SPEC_DIR = Path(suite_dir).resolve().parents[1] / "spec" / "demo_sandbox"  # noqa: F821
sys.path.insert(0, str(_SPEC_DIR))
from sandbox_model import AluModel, OP_ADD, OP_SUB, OP_XOR, OP_NOP  # noqa: E402
