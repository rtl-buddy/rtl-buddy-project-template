# `verif/demo_sandbox/` — SV/LVM Suite (vector-driven from Python golden)

The SV-side demonstrator suite for the sandbox tiny ALU. Pairs with
[`verif/demo_sandbox_cocotb/`](../sandbox_cocotb/), which runs the **same
...
3. **Coverage** — [`cov_alu.sv`](cov_alu.sv) cover-property labels
   ...
   [`spec/demo_sandbox/specs.yaml`](../../spec/demo_sandbox/specs.yaml).
...
|--------------------------|---------------------------------------------------------------------|
| Spec authoring           | [`spec/demo_sandbox/README.md`](../../spec/demo_sandbox/README.md)            |
