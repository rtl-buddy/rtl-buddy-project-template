// demo_alu_accel system-level testbench.
//
...
// post-run replay through spec/demo_alu_accel/demo_alu_accel_model.py.

`include "lvm_core.sv"

/* verilator lint_off SYNCASYNCNET */
module tb_top;
  `LVM_INIT("demo_alu_accel")
