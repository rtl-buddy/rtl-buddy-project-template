# `verif/alu_accel/` — System-Level Suite

System-level verification of the multi-clock ALU accelerator. Drives
the APB host stub against `alu_accel_top` over two incommensurate
...
The leaf-level sandbox suites ([`verif/sandbox/`](../sandbox/) and
[`verif/sandbox_cocotb/`](../sandbox_cocotb/)) prove the alu in
...
- [`design/alu_accel/alu_accel_csr.sv`](../../design/alu_accel/alu_accel_csr.sv) (PeakRDL-generated)
- [`design/alu_accel/alu_accel_compute.sv`](../../design/alu_accel/alu_accel_compute.sv)
- [`design/alu_accel/alu_accel_top.sv`](../../design/alu_accel/alu_accel_top.sv)

## Tests

```bash
(cd verif/alu_accel && uv run rb test csr_smoke)     # CSR-direct mode
(cd verif/alu_accel && uv run rb test fifo_stream)   # FIFO streaming mode
```
