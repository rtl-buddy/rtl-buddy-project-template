// alu_accel_synth_top — Flat-port synthesis wrapper.
//
...
// local apb_intf, which is then connected to alu_accel_top. Use this
// module as the synthesis top instead of alu_accel_top directly.

module alu_accel_synth_top (
  input  logic        apb_clk,
