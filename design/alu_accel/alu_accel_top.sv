// alu_accel_top — Multi-clock ALU accelerator.
//
// Three clock domains:
//   apb_clk     — APB bus + CSR block (alu_accel_csr, peakrdl-gen)
//   cclk        — compute domain (alu_accel_compute)
...
module alu_accel_top (
  ...
  // ────────── CSR block ──────────
  alu_accel_csr_pkg::alu_accel_csr__in_t  hwif_in;
  alu_accel_csr_pkg::alu_accel_csr__out_t hwif_out;
