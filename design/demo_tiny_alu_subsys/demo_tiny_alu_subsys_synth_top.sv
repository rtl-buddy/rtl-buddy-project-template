// demo_tiny_alu_subsys_synth_top — Flat-port synthesis wrapper.
//
...
// local apb_intf, which is then connected to demo_tiny_alu_subsys_top. Use this
// module as the synthesis top instead of demo_tiny_alu_subsys_top directly.

module demo_tiny_alu_subsys_synth_top (
  input  logic        apb_clk,
  ...
  demo_tiny_alu_subsys_top u_inner (
    .apb_clk, .apb_rst_n,
    .apb (bus),
    .cclk, .crst_n
  );
