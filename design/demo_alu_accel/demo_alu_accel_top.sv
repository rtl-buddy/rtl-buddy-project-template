// demo_alu_accel_top — Multi-clock ALU accelerator.
//
// Three clock domains:
//   apb_clk     — APB bus + CSR block (demo_alu_accel_csr, peakrdl-gen)
//   cclk        — compute domain (demo_alu_accel_compute)
...
module demo_alu_accel_top (
  ...
  // ────────── CSR block ──────────
  demo_alu_accel_csr_pkg::demo_alu_accel_csr__in_t  hwif_in;
  demo_alu_accel_csr_pkg::demo_alu_accel_csr__out_t hwif_out;

  demo_alu_accel_csr u_csr (
    .clk            (apb_clk),
    .rst_n          (apb_rst_n),
    .s_apb_psel     (apb.psel),
  ...
  demo_alu_accel_compute u_compute (
    .clk           (cclk),
    .rst_n         (crst_n),
