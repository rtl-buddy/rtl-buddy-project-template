...
// (basic propagation TB under verif/template_cdc_src_sync/).

module template_cdc_src_sync_block_a (
  input  logic clk_in,
  input  logic rst_n,
  input  logic d_in,
...
module template_cdc_src_sync_block_b (
  input  logic clk_in,
  input  logic rst_n,
  input  logic d_in,
...
module template_cdc_src_sync_block_c (
  input  logic clk_in,
  input  logic rst_n,
  input  logic d_in,
  output logic c_q
...
module template_cdc_src_sync_top (
  input  logic ck_a,
  input  logic rst_n,
  input  logic d_in,
  ...
  template_cdc_src_sync_block_a u_a (
    .clk_in     (ck_a),
    .rst_n      (rst_n),
    .d_in       (d_in),
  ...
  template_cdc_src_sync_block_b u_b0 (
    .clk_in  (ck_b0_int),
    .rst_n   (rst_n),
    .d_in    (a_q),
    .clk_out (ck_c0_int),
  ...
  template_cdc_src_sync_block_b u_b1 (
    .clk_in  (ck_b1_int),
    .rst_n   (rst_n),
    .d_in    (a_q),
    .clk_out (ck_c1_int),
  ...
  template_cdc_src_sync_block_c u_c0 (
    .clk_in (ck_c0_int),
    .rst_n  (rst_n),
    .d_in   (b0_q),
    .c_q    (q_out_c0)
  ...
  template_cdc_src_sync_block_c u_c1 (
    .clk_in (ck_c1_int),
    .rst_n  (rst_n),
    .d_in   (b1_q),
    .c_q    (q_out_c1)
