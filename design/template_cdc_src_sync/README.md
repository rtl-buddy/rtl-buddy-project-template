# template_cdc_src_sync — RTL

Synthesizable source-synchronous clock-forwarding chain. See
[`../../spec/template_cdc_src_sync/README.md`](../../spec/template_cdc_src_sync/README.md)
for the methodology overview and
[`../../lint/cdc/template_cdc_src_sync.sdc`](../../lint/cdc/template_cdc_src_sync.sdc)
for the integration SDC.

## Hierarchy

```text
template_cdc_src_sync_top
