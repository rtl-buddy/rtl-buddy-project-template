# `demo_tiny_alu_subsys` — Multi-clock APB-mapped ALU Accelerator
...
- [`design/demo_tiny_alu_subsys/`](../../design/demo_tiny_alu_subsys/) — compute wrapper + multi-clock top

## Clock domains

| Clock     | Used by                                                        |
|-----------|----------------------------------------------------------------|
| `apb_clk` | APB bus, `demo_tiny_alu_subsys_csr` (peakrdl-generated), FIFO write side |
| `cclk`    | `demo_tiny_alu_subsys_compute` (drives the alu), FIFO read side           |
...
See [`specs.yaml`](specs.yaml). Verification: [`verif/demo_tiny_alu_subsys/`](../../verif/demo_tiny_alu_subsys/).
