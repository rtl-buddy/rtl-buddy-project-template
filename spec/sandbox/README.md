...
See [`design/sandbox/README.md`](../../design/sandbox/README.md).
...
covergroup bin names in [`verif/sandbox/cov_alu.sv`](../../verif/sandbox/cov_alu.sv).
...
See [`verif/sandbox/testplan.md`](../../verif/sandbox/testplan.md) for the
mapping from tests to coverage IDs and pass criteria, and
[`verif/sandbox_cocotb/README.md`](../../verif/sandbox_cocotb/README.md)
