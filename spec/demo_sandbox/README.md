...
DUT. The Python golden model ([`sandbox_model.py`](sandbox_model.py)) is
...
See [`design/demo_sandbox/README.md`](../../design/demo_sandbox/README.md).
...
covergroup bin names in [`verif/demo_sandbox/cov_alu.sv`](../../verif/demo_sandbox/cov_alu.sv).
...
See [`verif/demo_sandbox/testplan.md`](../../verif/demo_sandbox/testplan.md) for the
mapping from tests to coverage IDs and pass criteria, and
[`verif/demo_sandbox_cocotb/README.md`](../../verif/demo_sandbox_cocotb/README.md)
