# `synth/demo_tiny_alu/` — Sandbox Synthesis Example

Yosys-based synthesis runs for the [tiny-ALU sandbox DUT](../../design/demo_tiny_alu/).
...
| File              | Purpose                                                        |
|-------------------|----------------------------------------------------------------|
| `synth.yaml`      | Two synthesis runs (`demo_tiny_alu_synth_generic`, `demo_tiny_alu_synth_nangate45`) |
